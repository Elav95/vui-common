...
from vui_common.app_data import (__version__,
                                 __date__,
                                 __app_description__,
                                 __app_name__,
                                 __admin_email__,
...
from vui_common.controllers.info import (identify_architecture_handler,
                                         get_origins_handler,
                                         ui_compatibility_handler,
                                         last_tags_from_github_handler,
                                         last_tag_velero_from_github_handler)


router = APIRouter()

tag_name = "Common Info"
...
tag_name = "Common Info Software Versions"
